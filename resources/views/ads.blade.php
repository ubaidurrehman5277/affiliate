		...
		<div class="container-fluid">
			<div class="row align-items-center">
				<div class="col-lg-12 col-md-12">
					<div class="container-fluid">
			<div class="row align-items-center">
				<div id="kt_toolbar_container" class="container-fluid container-fluid"><div class="row justify-content-between gy-4 gx-4"><div class="col-12 col-md-4 me-auto py-0"><form class="d-flex align-items-center reset-form"><div class="input-group" style="height: 40px; overflow: hidden;"><input type="text" class="form-control" name="search" placeholder="Search..." style="max-height: 40px;"><span class="position-absolute top-50 end-0 translate-middle-y lh-0 d-none me-1"><span class="spinner-border h-15px w-15px align-middle text-gray-400"></span></span><span class="btn btn-active-color-primary position-absolute top-50 end-0 translate-middle-y lh-0 d-none"><i class="bi bi-search fs-2"></i></span><button class="btn btn-secondary btn-icon submit-button" type="submit" style="display: block; border-top-right-radius: var(--bs-btn-border-radius); border-bottom-right-radius: var(--bs-btn-border-radius); border-bottom-left-radius: 0px; border-top-left-radius: 0px; height: 40px;"><i class="fas fa-search fs-2"></i></button><button class="btn btn-secondary btn-icon reset-button" type="reset" style="display: none;"><i class="bi bi-x-circle fs-2" style="margin-bottom: 1px;"></i></button></div></form></div><div class="col-12 col-md-8 py-0"><div class="row gy-4 gx-4"><div class="col-12 col-md-6"><div style="display: table; table-layout: fixed;"><div style="display: table-cell; width: 100%;"><select class="form-select w-100 step7" aria-label="Sorting" style="height: 40px;"><option value="sortby" disabled="">Sort By:</option><option value="ad_duplicates">Active Ads</option><option value="ad_trendFactor">Trending</option><option value="ad_performance">Performance</option><option value="moved_percentage">Percentage Change</option><option value="ad_date">Creation Date</option></select></div><div style="display: table-cell; padding-left: 5px;"><div role="group" class="MuiToggleButtonGroup-root css-1ya7z0e" style="height: 40px; overflow: hidden;"><button class="MuiButtonBase-root MuiToggleButton-root MuiToggleButton-sizeMedium MuiToggleButton-standard MuiToggleButtonGroup-grouped MuiToggleButtonGroup-groupedHorizontal css-q5cu77" tabindex="0" type="button" value="ASC" aria-pressed="false" aria-label="Ascending"><i class="fa-solid fa-up-long"></i><span class="MuiTouchRipple-root css-w0pj6f"></span></button><button class="MuiButtonBase-root MuiToggleButton-root Mui-selected MuiToggleButton-sizeMedium MuiToggleButton-standard MuiToggleButtonGroup-grouped MuiToggleButtonGroup-groupedHorizontal css-q5cu77" tabindex="0" type="button" value="DESC" aria-pressed="true" aria-label="Descending"><i class="fa-solid fa-down-long"></i><span class="MuiTouchRipple-root css-w0pj6f"></span></button></div></div></div></div><div class="col-12 col-md-6"><div style="display: flex; height: 42px;"><div style="display: table-cell; width: 100%;"><input type="text" class="form-control form-control-solid afdaterangepicker" placeholder="Pick date rage" readonly="" value="Last 30 Days" style="text-align: right; font-size: small; height: 40px;"></div><div style="display: table-cell; padding-left: 5px;"><div role="group" class="MuiToggleButtonGroup-root btn btn-outline px-0 py-0 btn-active-light-dark css-1ya7z0e" aria-label="Favorites" style="height: 40px; overflow: hidden;"><button class="MuiButtonBase-root MuiToggleButton-root MuiToggleButton-sizeMedium MuiToggleButton-standard MuiToggleButtonGroup-grouped MuiToggleButtonGroup-groupedHorizontal css-q5cu77" tabindex="0" type="button" value="onlyFav" aria-pressed="false" aria-label="Favorites" title="Only Favorites" style="overflow: hidden; border: none;"><i class="fas fa-heart fs-2 px-0 py-0 text-red"></i><span class="MuiTouchRipple-root css-w0pj6f"></span></button></div></div><div style="display: table-cell; padding-left: 5px; height: 40px;"><button type="button" title="Reset" class="btn btn-toolbar-reset btn-icon btn-outline btn-active-light-dark my-0 mx-0" style="height: 40px; overflow: hidden;"><i class="fas fa-undo-alt"></i></button></div></div></div></div></div></div></div>				
			</div>
		</div>
				</div>
			</div>
