          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                ...
                <form method="POST" action="{{ route('update_parent_category') }}" enctype="multipart/form-data"> 
               @csrf
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Name</label>
                        <input type="text" name="name" required class="form-control" value="{{$category->name}}" placeholder="Name">
                      </div>
                    </div>
