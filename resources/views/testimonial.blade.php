		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-12 col-sm-12">
					<div class="am-client-box">
						<div class="am-client-box-inner">
							<div class="am-client-heading">
								<div class="am-client-img">
									<img src="https://via.placeholder.com/60x60" alt="">
								</div>
								<div class="am-client-name">
									<h6>David Parker</h6>
									<p>UI / UX Designer</p>
								</div>
							</div>
							<div class="am-client-text">
								<p class="am-paragraph">Consectetur adipiscing elit seesd do eiusmod temepor inciese
									isddidunt ut labore eeset dolore magna aliqua. Quis ipsuesm suspendisse
									ultriices gravida ans these. labore eeset dolore magna aliqua. esdeesuis ipsuesm
									suspendisse ultrices gravida ans these dolore magna aliqua. esdeesuis ipsuesm
									suspendisse ultrices gravida ans these.

								</p>
							</div>
						</div>
						<div class="am-qoute-img">
							<span>
								<svg xmlns="http://www.w3.org/2000/svg" width="58.281" height="50.22"
									viewBox="0 0 58.281 50.22">
									<path class="cls-1"
